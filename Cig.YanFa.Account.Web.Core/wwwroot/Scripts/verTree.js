    ...
    tree.prototype = {
        ...
        tree_data: function (data, level, cl) {
            ...
            for (var i in data) {
                ...
                if (this.type == "form") {
                    icons = "<span><i class='verTreeIcon icon-check-box blue ver-tree-check ver-tree-checks' id='id_" + d[this.id] +"'></i><input type='checkbox' name='" + this.id + "[]'  value='" + d[this.id] + "' style='display: none'></span> "
                }
        ...
        list_item: function (info, child, level, changes, objs) {
            ...
            for (var i in info) {
                ...
                if (!objs) {
                    ...
                    if (changes) {
                        html += "<td align='center'><i class='verTreeIcon icon-check-box blue ver-tree-check ver-tree-checks' id='id_" + data[this.id] +"'></i><input type='checkbox' name='" + this.id + "[]'  value='" + data[this.id] + "' style='display: none'></td>"
                    }
                    ...
                    if (changes) {
                        html += "<td align='center'><i class='verTreeIcon icon-check-box blue ver-tree-check ver-tree-checks'></i><input type='checkbox' name='" + this.id + "[]' id='id_"+ data[this.id]+"' value='" + data[this.id] + "' style='display: none'></td>"
                    }
                    child.forEach(function (item) {
                        var file = item.getAttribute("data-field");
                        html += '<td>' + data[file] + '</td>';
